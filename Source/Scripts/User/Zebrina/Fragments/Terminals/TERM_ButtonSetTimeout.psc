...
Scriptname Zebrina:Fragments:Terminals:TERM_ButtonSetTimeout Extends Terminal Hidden Const
...
function SetButtonTimeout(float afValue)
    ...
    if (configureObjectRef != none && configureObjectRef is Zebrina:Workshop:ButtonScript)
        (configureObjectRef as Zebrina:Workshop:ButtonScript).fTimeoutSeconds = afValue
